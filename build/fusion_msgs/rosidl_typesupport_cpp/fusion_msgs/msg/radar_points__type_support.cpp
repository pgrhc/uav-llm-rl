...
static const _RadarPoints_type_support_symbol_names_t _RadarPoints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fusion_msgs, msg, RadarPoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fusion_msgs, msg, RadarPoints)),
  }
};
...
{
  return &::fusion_msgs::msg::rosidl_typesupport_cpp::RadarPoints_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fusion_msgs, msg, RadarPoints)() {
  return get_message_type_support_handle<fusion_msgs::msg::RadarPoints>();
}
