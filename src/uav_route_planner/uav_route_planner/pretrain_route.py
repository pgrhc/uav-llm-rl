...
UNIFIED_MAZE = False
RESUME_MODEL_PATH = "/home/ubuntu/Desktop/ros2_env/uav_ws/models/RouteCurriculum_20260429_100351/route_curriculum_550000_steps.zip"
RESUME_VECNORM_PATH = "/home/ubuntu/Desktop/ros2_env/uav_ws/models/RouteCurriculum_20260429_100351/route_curriculum_vecnormalize_550000_steps.pkl"
...
def main(args=None):
    ...
    if RESUME_VECNORM_PATH and os.path.exists(RESUME_VECNORM_PATH):
        print(f"VecNormalize yukleniyor: {RESUME_VECNORM_PATH}")
        env = VecNormalize.load(RESUME_VECNORM_PATH, vec_env)
        env.training = True
    ...
    if RESUME_MODEL_PATH and os.path.exists(RESUME_MODEL_PATH):
        print(f"Model yukleniyor: {RESUME_MODEL_PATH}")
        model = PPO.load(
            RESUME_MODEL_PATH,
            env=env,
            verbose=1,
